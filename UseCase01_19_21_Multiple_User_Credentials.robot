...
Verify the sidebar_1
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="menu"]   timeout=20
   AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="menu"]
   AppiumLibrary.Wait Until Page Contains    "Sachin AhujaStaff ID: 214248Role: RSM"   timeout=20
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="Yes, Logout"]  timeout=20
...
Verify Zone dropdown option_2
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.view.View[@text="NORTH"]   timeout=20
...
Verify region dropdown option_2
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.view.View[@text="NORTH 2"]   timeout=20
...
Verify the sidebar_2
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="menu"]   timeout=20
   AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="menu"]
   AppiumLibrary.Wait Until Page Contains    "B SURESHStaff ID: 173061Role: CHA"   timeout=20
...
Submit Credentials_3
    AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="Login"]   timeout=20
    AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="Login"]
...
Verify the sidebar_3
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="menu"]   timeout=20
   AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="menu"]
   AppiumLibrary.Wait Until Page Contains    "Mayank AgarwalStaff ID: 188603Role: TSM"  timeout=20
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Logout"]  timeout=20
   AppiumLibrary.Click Element    xpath=//android.widget.TextView[@text="Logout"]
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="Yes, Logout"]  timeout=20
   AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="Yes, Logout"]
   Close Application
...
Verify the sidebar_4
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="menu"]   timeout=20
   AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="menu"]
   AppiumLibrary.Wait Until Page Contains    "Amit MishraStaff ID: 420696Role: HOC"   timeout=20
...
Verify the sidebar_5
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="menu"]   timeout=20
   AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="menu"]
   AppiumLibrary.Wait Until Page Contains    "Naveen KumarStaff ID: 203408Role: HO2"    timeout=20
