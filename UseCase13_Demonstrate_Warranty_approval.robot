...
Warranty Approvals Job Card
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="CCP"]   timeout=150
...
job status
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.view.View[@text="10th Free Service"]   timeout=150
...
Put JC on Hold
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.view.View[@text="JC22002041 icon chip PENDING icon Dealer Details AKANKSHA AUTOMOBILES (RUDRAPUR) PVT LTD almost 2 years ago icon Creation Date 23/06/2022 icon Vehicle Reg No. TEMPtimeou=907377 icon Channel Arena icon Service Type No Data Available Individual Claim Status PENDING Parallel Claim Status"]    timeout=150
   ...
   Press Keycode    4
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.webkit.WebView[@text="ServizApp"]/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.view.View[4]/android.view.View/android.view.View/android.view.View/android.view.View/android.widget.TextView   timeout=150
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Put Job Card on-Hold?"]     timeout=150
   AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="Put Job Card On Hold"]
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Job Card Submitted"]   timeout=150
...
job status_1
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.webkit.WebView[@text="ServizApp"]/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View[3]/android.view.View/android.view.View/android.view.View   timeout=150
   AppiumLibrary.Click Element    xpath=//android.webkit.WebView[@text="ServizApp"]/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View[3]/android.view.View/android.view.View/android.view.View
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.view.View[@text="HOLD"]   timeout=150
...
Click_Dialog_Button_For_Specific_Number_Of_Times_4
    FOR  ${index}  IN RANGE  ${MAX_CLICKS}
        ${check_element}=  Run Keyword and Return Status   AppiumLibrary.Wait Until Page Contains Element    xpath=//android.app.Dialog/android.view.View/android.view.View[1]/android.view.View[2]/android.widget.Button    timeou=90
              Run Keyword If      '${check_element}' == 'True'     AppiumLibrary.Click Element  xpath=//android.app.Dialog/android.view.View/android.view.View[1]/android.view.View[2]/android.widget.Button
    END
...
Click_Dialog_Button_For_Specific_Number_Of_Times_5
    FOR  ${index}  IN RANGE  ${MAX_CLICKS}
          ${check_element}=  Run Keyword and Return Status   AppiumLibrary.Wait Until Page Contains Element    xpath=//android.app.Dialog/android.view.View/android.view.View[1]/android.view.View[3]/android.widget.Button    timeou=90
                Run Keyword If      '${check_element}' == 'True'     AppiumLibrary.Click Element  xpath=//android.app.Dialog/android.view.View/android.view.View[1]/android.view.View[3]/android.widget.Button
    END
*** Test cases ***
...
Reject All Parts
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Job Card List"]   timeout=150
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.view.View[@text="JC22002041 icon chip HOLD icon Dealer Details AKANKSHA AUTOMOBILES (RUDRAPUR) PVT LTD almost 2 years ago icon Creation Date 23/06/2022 icon Vehicle Reg No. TEMPtimeou=907377 icon Channel Arena icon Service Type No Data Available Individual Claim Status PENDING Parallel Claim Status"]   timeout=150
   AppiumLibrary.Click Element    xpath=//android.view.View[@text="JC22002041 icon chip HOLD icon Dealer Details AKANKSHA AUTOMOBILES (RUDRAPUR) PVT LTD almost 2 years ago icon Creation Date 23/06/2022 icon Vehicle Reg No. TEMPtimeou=907377 icon Channel Arena icon Service Type No Data Available Individual Claim Status PENDING Parallel Claim Status"]
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Warranty Approval"]   timeout=150
   Swipe    932    1533    817    582
   Swipe    932    1533    817    582
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Job Card Submitted"]   timeout=150
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Back to home"]   timeout=150
   AppiumLibrary.Click Element    xpath=//android.widget.TextView[@text="Back to home"]
...
job status_2
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.webkit.WebView[@text="ServizApp"]/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View[3]/android.view.View/android.view.View/android.view.View   timeout=150
   AppiumLibrary.Click Element    xpath=//android.webkit.WebView[@text="ServizApp"]/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View[3]/android.view.View/android.view.View/android.view.View
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.view.View[@text="REJECTED"]   timeout=150
...
Click on search_2
   ...
   AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="Search"]
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Job Card List"]    timeout=150
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.view.View[@text="JC22002041 icon Dealer Details AKANKSHA AUTOMOBILES (RUDRAPUR) PVT LTD almost 2 years ago icon Creation Date 23/06/2022 icon Vehicle Reg No. TEMPtimeou=907377 icon Channel Arena icon Service Type No Data Available Individual Claim Status REJECTED Parallel Claim Status PENDING"]   timeout=150
   sleep  2
Close app_2
   Close Application
...
Search_4
   ...
   AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="Search"]
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Job Card List"]   timeout=150
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.view.View[@text="JC22002041 icon Dealer Details AKANKSHA AUTOMOBILES (RUDRAPUR) PVT LTD almost 2 years ago icon Creation Date 23/06/2022 icon Vehicle Reg No. TEMPtimeou=907377 icon Channel Arena icon Service Type No Data Available Individual Claim Status PENDING Parallel Claim Status REJECTED"]   timeout=150
