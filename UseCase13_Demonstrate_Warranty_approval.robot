...
Warranty Approvals Job Card
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="CCP"]   timeout=90
...
Put JC on Hold
   ...
   Press Keycode    4
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.webkit.WebView[@text="ServizApp"]/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.view.View[4]/android.view.View/android.view.View/android.view.View/android.view.View/android.widget.TextView   timeout=90
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Put Job Card on-Hold?"]     timeout=90
   AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="Put Job Card On Hold"]
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Job Card Submitted"]   timeout=90
...
Reject All Parts
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Job Card Submitted"]   timeout=90
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Back to home"]   timeout=90
   AppiumLibrary.Click Element    xpath=//android.widget.TextView[@text="Back to home"]
...
Search_4
   ...
   AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="Search"]
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Job Card List"]   timeout=90
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.view.View[@text="JC22002041 icon Dealer Details AKANKSHA AUTOMOBILES (RUDRAPUR) PVT LTD almost 2 years ago icon Creation Date 23/06/2022 icon Vehicle Reg No. TEMPtimeou=907377 icon Channel Arena icon Service Type No Data Available Individual Claim Status PENDING Parallel Claim Status REJECTED"]   timeout=90
