...
No Data Found
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="No Data Found !"]  timeout=70
   Sleep    2
...
2 part approve 2 parts reject
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=(//android.widget.TextView[@text="Approve"])[1]  timeout=70
   AppiumLibrary.Click Element    xpath=(//android.widget.TextView[@text="Approve"])[1]
   Swipe    932    1533    817    582
   Swipe    932    1533    817    582
...
All Approved
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Job Card List"]   timeout=70
   #AppiumLibrary.Click Element    xpath=//android.view.View[@text="JC20012647 icon chip APPROVED icon Dealer Details DEWARS GARAGE LTD over 3 years ago icon Creation Date 29/12/2020 icon Vehicle Reg No. WB23E8870 icon Channel Arena icon Service Type No Data Available Individual Claim Status APPROVED"]
   AppiumLibrary.Wait Until Element Is Visible    xpath=(//android.view.View[@text="JC20012647 icon chip APPROVED icon Dealer Details DEWARS GARAGE LTD over 3 years ago icon Creation Date 29/12/2020 icon Vehicle Reg No. WB23E8870 icon Channel Arena icon Service Type No Data Available Individual Claim Status APPROVED"])[1]   timeout=70
   AppiumLibrary.Wait Until Element Is Visible    xpath=(//android.view.View[@text="JC20012647 icon chip APPROVED icon Dealer Details DEWARS GARAGE LTD over 3 years ago icon Creation Date 29/12/2020 icon Vehicle Reg No. WB23E8870 icon Channel Arena icon Service Type No Data Available Individual Claim Status APPROVED"])[2]   timeout=70
   sleep  2
   Close Application