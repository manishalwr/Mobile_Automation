...
Warranty Approvals Job Card
   ...
   AppiumLibrary.Click Element    xpath=//android.webkit.WebView[@text="ServizApp"]/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View[1]/android.view.View/android.view.View/android.view.View
   sleep  6
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.view.View[@text="1002 - THE MITHRA AGENCIES"]
   AppiumLibrary.Click Element    xpath=//android.view.View[@text="1002 - THE MITHRA AGENCIES"]
   ...
   Sleep  4
   AppiumLibrary.Click Element    xpath=//android.view.View[@text="04"]
   Sleep  2
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Job Card List"]
