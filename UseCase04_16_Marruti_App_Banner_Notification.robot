...
Verify Zone dropdown option
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.view.View[@text="NORTH"]   timeout=150
...
Verify region dropdown option
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.view.View[@text="NORTH 1"]   timeout=150
...
Others tab info
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.view.View[@text="Warranty Others Banner Notifications"]   timeout=150
   AppiumLibrary.Click Element    xpath=//android.view.View[@text="Warranty Others Banner Notifications"]
   sleep  2
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.webkit.WebView[@text="ServizApp"]/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.view.View   timeout=150
...
Select date
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Select Date"]   timeout=150
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="30"]   timeout=150
...
Create the dummy notofication
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.webkit.WebView[@text="ServizApp"]/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View[2]/android.view.View   timeout=150
   ...
   Press Keycode    4
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="Publish"]   timeout=150
   AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="Publish"]
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Publishing Banner Notification"]   timeout=150
   AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="Publish"]
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Published Successfully"]   timeout=150
   AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="Dismiss"]

Draft Banner Notification
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.view.View[@text="Banner Notification Create an alert on the homepage."]  timeout=150
...
Select date again
   ...
   Press Keycode    4
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="back-button"]   timeout=150
   AppiumLibrary.Click Element    xpath=//android.widget.TextView[@text="back-button"]
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="Save Draft"]   timeout=150
   AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="Save Draft"]
   sleep  2
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Banner Notification"]    timeout=150
...
Verify Banner notifications should be visible
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.webkit.WebView[@text="ServizApp"]/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.widget.TextView   timeout=150
...
Verify homepage tabs_1
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Notifications"]   timeout=150
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="Done"]    timeout=150
   AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="Done"]
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="testing2345testing458"]   timeout=150
   Close Application
