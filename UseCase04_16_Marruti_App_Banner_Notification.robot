...
Verify region dropdown option
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.view.View[@text="NORTH 1"]   timeout=90
...
Others tab info
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.view.View[@text="Warranty Others Banner Notifications"]   timeout=90
...
Select date
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Select Date"]   timeout=90
   AppiumLibrary.Click Element    xpath=//android.widget.TextView[@text="Select Date"]
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="26"]   timeout=90
   AppiumLibrary.Click Element   xpath=//android.widget.Button[@text="26"]
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="30"]   timeout=90
   AppiumLibrary.Click Element   xpath=(//android.widget.Button[@text="30"])[2]
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="Done"]   timeout=90
   AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="Done"]

Create the dummy notofication

   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.webkit.WebView[@text="ServizApp"]/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View[2]/android.view.View   timeout=90
   ...
   Press Keycode    4
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="Publish"]   timeout=90
   AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="Publish"]
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Publishing Banner Notification"]   timeout=90
   AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="Publish"]
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Published Successfully"]   timeout=90
   AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="Dismiss"]

Draft Banner Notification
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.view.View[@text="Banner Notification Create an alert on the homepage."]  timeout=90
...
Select date again
   ...
   Press Keycode    4
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="back-button"]   timeout=90
   AppiumLibrary.Click Element    xpath=//android.widget.TextView[@text="back-button"]
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="Save Draft"]   timeout=90
   AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="Save Draft"]
   sleep  2
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Banner Notification"]    timeout=90
...
Verify Banner notifications should be visible
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.webkit.WebView[@text="ServizApp"]/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.widget.TextView   timeout=90
...
Verify homepage tabs_1
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Notifications"]   timeout=90
   AppiumLibrary.Click Element    xpath=//android.widget.TextView[@text="Banner Notifications"]
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Custom"]   timeout=90
   AppiumLibrary.Click Element    xpath=//android.widget.TextView[@text="Custom"]
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="1"]    timeout=90
