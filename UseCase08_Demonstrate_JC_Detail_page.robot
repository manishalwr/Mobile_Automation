...
Select date filter_1
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="MAY 2024"]
...
Select date filter_3
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="28"]   timeout=70
