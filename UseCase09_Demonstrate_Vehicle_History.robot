...
Handle Logout Prompt_1
    ...
    #AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="Yes, Logout from other devices"]   timeout=50
...
Vehicle History page
    AppiumLibrary.Wait Until Element Is Visible    xpath=//android.view.View[@text="icons Vehicle History"]   timeout=50
    ...
    AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="Visit History (1)"]   timeout=50
    AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="Visit History (1)"]
    AppiumLibrary.Wait Until Page Contains    JC19020578   timeout=70
    AppiumLibrary.Element Should Be Visible    xpath=//android.widget.TextView[@text="JC19020578"]
    AppiumLibrary.Wait Until Element Is Visible    xpath=//android.view.View[@text="View Detail"]   timeout=50
...
Submit Credentials_1
    AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="Login"]   timeout=50
    AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="Login"]
...
Vehicle History page_1
    AppiumLibrary.Wait Until Element Is Visible    xpath=//android.view.View[@text="icons Vehicle History"]   timeout=70
    AppiumLibrary.Click Element    xpath=//android.view.View[@text="icons Vehicle History"]
    AppiumLibrary.Wait Until Page Contains    "Vehicle Summary"  timeout=70
    AppiumLibrary.Element Should Be Visible    xpath=//android.widget.Button[@text="Vehicle Summary"]
    AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="Visit History (1)"]   timeout=70
    AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="Visit History (1)"]
    AppiumLibrary.Wait Until Page Contains    JC20012647   timeout=70
    AppiumLibrary.Element Should Be Visible    xpath=//android.widget.TextView[@text="JC20012647"]
    AppiumLibrary.Wait Until Page Contains    "View Detail"   timeout=70
    AppiumLibrary.Click Element    xpath=//android.view.View[@text="View Detail"]
    Sleep    2
    Close Application