...
*** Test Cases ***
Launch App Test
     AppiumLibrary.Open Application    ${REMOTE_URL}    app=${APP}   platformName=${PLATFORM_NAME}      deviceName=${DEVICE_NAME}    appPackage=${APP_PACKAGE}    appActivity=${APP_ACTIVITY}   automationName=${AUTOMATION_NAME}
...
Handle Logout Prompt
    ...
    AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="Yes, Logout from other devices"]     timeout=150
...
Verify Zone dropdown option
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.view.View[@text="EAST"]   timeout=150
...
Verify region dropdown option
   ...
   #Press Keycode    4
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.view.View[@text="EAST 1"]    timeout=150
...
Verify homepage tabs
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.view.View[@content-desc="Warranty Warranty Parts Approval & More"]/android.view.View[1]   timeout=150
...
Warranty Approvals Reports
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.webkit.WebView[@text="ServizApp"]/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.view.View[2]   timeout=150
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.RadioButton[@text="Monthly"]   timeout=150
...
#   
Select custom cal
  AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Custom"]   timeout=150
  AppiumLibrary.Click Element    xpath=//android.widget.TextView[@text="Custom"]
  AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="MAY 2024"]    timeout=150
  AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="MAY 2024"]
  AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="APR"]   timeout=150
  AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="APR"]
  AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="1"]  timeout=150
  AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="1"]
  AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="26"]   timeout=150
  AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="26"]
  AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="Done"]   timeout=150
  AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="Done"]

Select zone
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.webkit.WebView[@text="ServizApp"]/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.view.View   timeout=150
...
Select Region
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.webkit.WebView[@text="ServizApp"]/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View[3]/android.view.View/android.view.View/android.view.View    timeout=150
...
Select workshop code/name
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.webkit.WebView[@text="ServizApp"]/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View[4]/android.view.View/android.view.View/android.view.View   timeout=150
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.view.View[@text="0605 - DEWARS GARAGE LTD"]   timeout=150
...
Select outlet code
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.webkit.WebView[@text="ServizApp"]/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View[5]/android.view.View/android.view.View/android.view.View   timeout=150
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.view.View[@text="01"]  timeout=150
   AppiumLibrary.Click Element    xpath=//android.view.View[@text="01"]
   Press Keycode    4

Enter email to
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.webkit.WebView[@text="ServizApp"]/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View[6]/android.view.View/android.view.View/android.widget.EditText   timeout=150
...
Email CC
   sleep  2
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.webkit.WebView[@text="ServizApp"]/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View[7]/android.view.View/android.view.View/android.widget.EditText   timeout=150
...
Send reports
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="Send Report"]   timeout=150
   AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="Send Report"]

Send Done
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Report Sent Successfully!"]   timeout=150
   AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="Done"]
