...
Verify the bell icon
    AppiumLibrary.Wait Until Element Is Visible    xpath=//android.view.View[@text="Homepage"]/android.view.View/android.view.View/android.view.View/android.view.View[3]/android.widget.Image[2]   timeout=150
    ...
    AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="All Types"]   timeout=150

Verify the JC Alerts 
    AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="JC Alerts"]   timeout=150
...
Select Banner Notification
    #For last 90 days
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.webkit.WebView[@text="ServizApp"]/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View[2]   timeout=150
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Last 90 days"]   timeout=150
...
Click_Dialog_Button_For_Specific_Number_Of_Times_1
    FOR  ${index}  IN RANGE  ${MAX_CLICKS}
	    AppiumLibrary.Wait Until Element Is Visible    xpath=//android.app.Dialog/android.view.View/android.view.View[1]/android.view.View[2]/android.widget.Button    timeout=150
        AppiumLibrary.Click Element  xpath=${DIALOG_BUTTON_XPATH1}
    END
*** Test cases ***
Select date filter_2
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="JAN"]    timeout=150
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="JAN 2015"]   timeout=150
...
Click_Dialog_Button_For_Specific_Number_Of_Times_2
    FOR  ${index}  IN RANGE  ${MAX_CLICKS}
        AppiumLibrary.Wait Until Element Is Visible    xpath=//android.app.Dialog/android.view.View/android.view.View[1]/android.view.View[3]/android.widget.Button  timeout=150
...
Select date filter_3
   ...
   AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.Button[@text="28"]     timeout=150
   ...
   AppiumLibrary.Click Element    xpath=//android.widget.Button[@text="Done"]
    ...
    Swipe    791    664    791    1822
    #For last 30 days
    AppiumLibrary.Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="Last 30 days"]   timeout=150
